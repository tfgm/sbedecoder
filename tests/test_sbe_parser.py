...
class TestSBEParserLibrary:
    def __init__(self):
        ...
        self.schema_url = 'ftp://ftp.cmegroup.com/SBEFix/Production/Templates/templates_FixBinary.xml'
    ...
    def test_security_status_reset_statistics(self):
        with tempfile.NamedTemporaryFile(mode='w') as temp:
            urllib.urlretrieve(self.schema_url, temp.name)

            schema = SBESchema()
            schema.parse(temp.name)
